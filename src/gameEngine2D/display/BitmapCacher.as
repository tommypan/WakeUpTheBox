package gameEngine2D.display 
{
	...
	public class BitmapCacher
	{
		 ...
		 * <p>注：在player10之前的版本中，重绘机制比较笨拙，所以必须好要做一些像素剔除，边缘判断等。但是之后已经有很大改进，故在此省了一些步骤</p>
		 ...
		 */
		static ge2d function cacheFrame(mc:MovieClip/*, transparent:Boolean = true, fillColor:uint = 0x00000000*/, scale:Number = 1):BitmapFrameInfo
		{
			...
			if(rect.height<1 || rect.width<1)//防止无效的bitmapData异常
			{
				bitInfo = null;
			}else{
		 ...
		 * @return 位图信息数组
		 */ 
		static ge2d function cacheBitmapMovie(source:MovieClip/*, transparent:Boolean = true, fillColor:uint = 0x00000000*/, scale:Number = 1):Vector.<BitmapFrameInfo>
		{
